                    ...
                    <div class="product-box">
                        <div class="img-wrapper">
                            <a href="{{ route('shop.product.details', ['slug' => $product->slug]) }}">
                                ...
                                <img src="assets/images/fashion/product/front/{{ $product->image }}" class="w-100 bg-img blur-up lazyload" alt="{{ $product->name }}">
                            </a>
                ...
                <div class="category-wrapper category-slider1 white-arrow category-arrow">
                    @foreach ($products as $product)
                        <a href="{{ $product->url }}" class="category-wrap category-padding">
                            <img src="assets/images/fashion/product/front/{{ $product->category->image }}" class="bg-img blur-up lazyload" alt="category image">

                            <div class="category-content category-text-1">
                                <h3 class="theme-color">{{ $product->category->name }}</h3>
                            </div>
                        </a>
                    @endforeach
                </div>
