                            ...
                            <div class="col-md-6">
                                <div class="cloth-details-size">
                                    ...
                                    <div class="product-buttons">
                                        ...
                                        <a  onclick="event.preventDefault();document.getElementById('addtocart').submit();"
                                        href="javascript:void(0)" id="cartEffect"
                            ...
                            <div class="product-box">
                                ...
                                <div class="product-details">
                                    <div class="rating-details">
                                        <span class="font-light grid-content">{{ $rproduct->name }}</span>
